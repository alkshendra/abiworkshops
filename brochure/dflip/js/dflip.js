...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (typeof dFlipLocation !== 'undefined') {
      ...
      DFLIP.defaults.mockupjsSrc = dFlipLocation + "dflip/js/libs/mockup.min.js";
      DFLIP.defaults.pdfjsSrc = dFlipLocation + "dflip/js/libs/pdf.min.js";
      DFLIP.defaults.pdfjsCompatibilitySrc = dFlipLocation + "dflip/js/libs/compatibility.js";
      DFLIP.defaults.threejsSrc = dFlipLocation + "dflip/js/libs/three.min.js";
      DFLIP.defaults.pdfjsWorkerSrc = dFlipLocation + "dflip/js/libs/pdf.worker.min.js";
      DFLIP.defaults.soundFile = dFlipLocation + "dflip/sound/turn2.mp3";
      DFLIP.defaults.imagesLocation = dFlipLocation + "dflip/images";
      DFLIP.defaults.imageResourcesPath = dFlipLocation + "dflip/images/pdfjs/";
